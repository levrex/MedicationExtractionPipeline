...
class tagObject(object):
    ...
    def setCapture(self, d_groups):
        self.__capture = d_groups
    ...
    def getBriefDescription(self):
        ...
        description+= u"""<capture> {0} </capture> """.format(self.getCapture())
        return description

    def getCapturingCode(self):
        """returns the term defining this object"""
        return self.__item.getCapturingCode()
